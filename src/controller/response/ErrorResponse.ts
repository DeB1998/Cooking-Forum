...
/**
 * Basic interface describing the body of all the HTTP responses this application generates when
 * errors occur while serving the corresponding HTTP request.
 */
