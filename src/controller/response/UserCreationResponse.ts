...
/**
 * Interface describing the body of the HTTP response the application generates when the user has
 * been successfully registered into the application.
 */
export interface UserCreationResponse extends SuccessfulResponse {
    /**
     * Flag indicating that the user has been successfully registered into the application.
     */
    created: true;
}
